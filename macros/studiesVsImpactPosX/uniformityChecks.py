...
for i,bar in enumerate(goodbars):
  ...
  en_LR.Write('energyL-RNorm_vs_refbar_Vov%.02f_th%s_bar%i'%(vov,refth, bar))
  en_L.Write('energyLNorm_vs_refbar_Vov%.02f_th%s_bar%i'%(vov,refth, bar))
  en_R.Write('energyRNorm_vs_refbar_Vov%.02f_th%s_bar%i'%(vov,refth,bar))
