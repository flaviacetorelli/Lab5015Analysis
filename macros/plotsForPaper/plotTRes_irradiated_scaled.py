...
if sipmProd == 'HPK':
    ...
    fnames = { 15 : '/eos/cms/store/group/dpg_mtd/comm_mtd/TB/MTDTB_H8_Sep2023/ANALYSIS/TOFHIR2C/RootFiles/plots_timeResolution_2E14_15um_T2_TBJune22_TOFHIR2X.root',
    ...
    gnames = { 15 : 'g_data_vs_Vov_average_FBK_2E14_LYSO797_T-40C',  # less annealing for this module - TB June2022
               25 : 'module25_LYSO200113_FBK_C25_Rq2_T2_2e14'# TB Sept 2023
              }
...
xmin = 0.
xmax = 2.4
hPad = ROOT.gPad.DrawFrame(xmin,40.,xmax,140.)
...
tl2.DrawLatex(0.20,0.26,'%s'%sipmProd)
...
tl.DrawLatex(0.20,0.20,'2 #times 10^{14} 1 MeV n_{eq}/cm^{2}')
