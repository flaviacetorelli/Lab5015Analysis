...
outdir = '/eos/user/f/fcetorel/www/MTD/plot4BTLpaper/others/minorRevJINST_Nov24/'

markers = {
        0 : 20, # ROOT.kFullCircle,
        1 : 21, # ROOT.kFullSquare,
        2 : 22, # ROOT.kFullTriangleUp,
        3 : 23, # ROOT.kFullTriangleDown,
        #4 : 29  #ROOT.kFullStar #33 #34
        4 : 47  #ROOT.kFullCross
        }
...
for ivov, vov in enumerate(Vovs):
    ...
    g[vov].SetMarkerStyle(markers[ivov])
    g[vov].SetMarkerSize(1)
    if markers[ivov] == 22 or markers[ivov] == 23: g[vov].SetMarkerSize(1.15)
    elif markers[ivov] == 47: g[vov].SetMarkerSize(1.25)
...
for ivov, vov in enumerate(Vovs):
    ...
    g2[vov].SetMarkerStyle(markers[ivov])
    if markers[ivov] == 22 or markers[ivov] == 23: g2[vov].SetMarkerSize(1.15)
    elif markers[ivov] == 47: g2[vov].SetMarkerSize(1.25)
    g2[vov].Draw('plsame')
