...
for i,bar in enumerate(goodbars):
  en_LR = gg_en['energyL-R_vs_refbar_Vov%.02f_th05_bar%i'%(vov, bar)]
  en_L = gg_en['energyL_vs_refbar_Vov%.02f_th05_bar%i'%(vov, bar)]
  en_R = gg_en['energyR_vs_refbar_Vov%.02f_th05_bar%i'%(vov,bar)]

  outfile.cd()
  en_LR.Write('energyL-R_vs_refbar_Vov%.02f_th05_bar%i'%(vov, bar))
  en_L.Write('energyL_vs_refbar_Vov%.02f_th05_bar%i'%(vov, bar))
  en_R.Write('energyR_vs_refbar_Vov%.02f_th05_bar%i'%(vov,bar))
